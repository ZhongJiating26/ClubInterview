...
-- 导出  表 campus_club_interview.interview_record 结构
CREATE TABLE IF NOT EXISTS `interview_record` (
  ...
  `signup_session_id` int DEFAULT NULL,
  `candidate_user_id` int NOT NULL,
  `interviewer_id` int NOT NULL,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_score` float DEFAULT NULL,
  `summary` text COLLATE utf8mb4_unicode_ci,
  `record_text` text COLLATE utf8mb4_unicode_ci,
  ...
  `transcript_status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transcript_text` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `ix_interview_record_is_deleted` (`is_deleted`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 正在导出表  campus_club_interview.interview_record 的数据：~0 rows (大约)
